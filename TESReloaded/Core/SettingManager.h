...
#define WaterDisplacementMapSize 256
#define WaterHeightMapSize 256
...
#define kSetting1stPersonFoV 0x00B0313C
...
static const UInt32*	SettingMultiSample				= (UInt32*)0x00B06D0C; // Only Oblivion
static const UInt8*		SettingHDR						= (UInt8*)0x00B06DE4; // Only Oblivion
